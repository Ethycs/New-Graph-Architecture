...
The drivers cluster contains 7 atomic notes defining the shared contracts between the architecture half and the experiment half of the system. Every file format, flag schema, and CLI interface that both halves must agree on lives here. Read this cluster first — it is the spine of the entire build.
