...
- **Output:** (to [Graph FSM](./graph-fsm.md) and [Confusion Graph](./confusion-graph.md)) typed graph $\Gamma(X_G) = (V, E, w_v, g_v, m_v)$ with weights, labels, and monodromy annotations.
...
## Links
- **See also:** [Graph Realization Functor](./graph-realization-functor.md), [Graph FSM](./graph-fsm.md), [Confusion Graph](./confusion-graph.md)
