...
- **See also:** [E24 Graph Extraction](../../exp/e24-graph-extraction.md), [Forward Backward](../energy/forward-backward.md), [Posterior Mask](../energy/posterior-mask.md), [Bayesian Nonparametric K](../energy/bayesian-nonparametric-k.md).
...
- **Driven by:** the over-clustered output of [Bayesian Nonparametric K](../energy/bayesian-nonparametric-k.md) + [Hidden State Harvester](../substrate/hidden-state-harvester.md).
