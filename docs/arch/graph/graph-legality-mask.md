...
## Interface
- **Input:** (from [Typed Score Record](../typed/typed-score-record.md)) logits/scores over all possible next states $q'$.
...
## Links
- **See also:** [Graph FSM](graph-fsm.md), [Typed Field Pipeline](../typed/typed-field-pipeline.md)
