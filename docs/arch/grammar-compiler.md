...
- **See also:** (typed-graph-spec — external driver), [Typed Readout Layer](./typed-readout-layer.md)
- **Drives:** [Typed Readout Layer](./typed-readout-layer.md), (grammar-correctness-audit — planned experiment)
