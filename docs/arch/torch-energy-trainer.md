...
- **See also:** [Energy Minimisation Trainer](./energy-minimization-trainer.md), [Frozen Encoder Torch](./frozen-encoder-torch.md), [Typed Readout Torch](./typed-readout-torch.md), [Posterior Mask](./posterior-mask.md).
