...
- **See also:** [Hidden State Harvester](../substrate/hidden-state-harvester.md), [Typed Latent Clustering](../typed/typed-latent-clustering.md), [Forward Backward](forward-backward.md).
- **Drives:** the graph-extraction runner (E24, in development); the Phase 20 Tier 1 / Tier 2 / Tier 3 validation tiers in the proposal.
- **Driven by:** the harvested hidden-state matrix produced by [Hidden State Harvester](../substrate/hidden-state-harvester.md).
