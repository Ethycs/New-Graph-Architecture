...
- **See also:** [Torch Energy Trainer](torch-energy-trainer.md), [Energy Function](energy-function-E.md), [Posterior Mask](posterior-mask.md), [Hyperbolic Embedding](../hyperbolic/hyperbolic-embedding.md).
