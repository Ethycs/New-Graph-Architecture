...
- **See also:** [Hyperbolic Embedding](./hyperbolic-embedding.md), [Hyperbolic Distance Loss](./hyperbolic-distance-loss.md), [Graph Prototype Vectors](./graph-prototype-vectors.md).
