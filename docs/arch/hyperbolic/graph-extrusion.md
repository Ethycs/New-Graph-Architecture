...
## Why
A discrete graph has no meaningful interior; every point is a vertex or edge. Extrusion creates a stratified manifold with-boundary where singularities appear as violations of Whitney conditions at stratum interfaces. This geometry houses the [Singularity Detector σ(x)](../singularity/singularity-detector.md), which evaluates whether observation clusters respect stratum boundaries. Without extrusion, singularities remain abstract; with it, they are geometric codimension-1 events in an ambient space.
...
- [Stratified Partition Function](../energy/stratified-partition-function.md) coordinates.
...
- Tag each observation with stratum type; verify [Stratified Partition Function](../energy/stratified-partition-function.md) conditions.

## Links
- **See also:** [Hyperbolic Embedding](hyperbolic-embedding.md), [Stratified Partition Function](../energy/stratified-partition-function.md)
