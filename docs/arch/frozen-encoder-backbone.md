...
**Cluster:** arch
**Status:** spec
**Tags:** #reservoir #training #efficiency
...
- State embedding: passed to [Typed Readout Layer](./typed-readout-layer.md) for further processing.
...
4. **Connect to readout:** Feed the frozen embeddings $\mathbf{h}$ directly to the [Typed Readout Layer](./typed-readout-layer.md). Do not insert additional trainable layers between encoder and readout.
...
- **See also:** [Typed Readout Layer](./typed-readout-layer.md)
- **Drives:** [Typed Readout Layer](./typed-readout-layer.md), (readout-ablation — planned experiment)
