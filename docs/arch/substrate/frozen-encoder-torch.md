...
- **See also:** [Frozen Encoder Backbone](frozen-encoder-backbone.md), [Torch Energy Trainer](../energy/torch-energy-trainer.md), [Typed Readout Torch](../typed/typed-readout-torch.md).
