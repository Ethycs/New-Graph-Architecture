...
- **See also:** [Typed Latent Clustering](../typed/typed-latent-clustering.md), [Bayesian Nonparametric K](../energy/bayesian-nonparametric-k.md), [Forward Backward](../energy/forward-backward.md).
